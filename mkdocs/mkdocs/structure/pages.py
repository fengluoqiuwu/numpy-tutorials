...
class Page(StructureItem):
    ...
    source_url: str | None
    """The full, canonical URL to the current page source as determined by the value"""
    ...
    def _set_canonical_url(self, base: str | None) -> None:
        if base:
            ...
            self.source_url = base + "_sources/" + self.file.src_path
        else:
    ...
    @property
    def download_md(self) -> str | None:
        return self.source_url

    @property
    def download_jpynb(self) -> str | None:
        return self.source_url.replace(".md", ".jpynb")

    @property
    def download_pdf(self) -> str | None:
        return self.source_url.replace(".md", ".pdf")
